...
short walk. The city provides its citizens with a Walk Generating 
App on their phones -- everytime you press the button it sends 
you an array of one-letter strings representing directions to 
walk (eg. ['n', 's', 'w', 'e']). You always walk only a single 
block for each letter (direction) and you know it takes you one 
...
ten minutes (you don't want to be early or late!) and will, of 
...
const isValidWalk = (walk) => te;
walk.length == 10 &&
  !walk.reduce((prev, curr) => prev + { n: 1, s: -1, w: -2, e: 2 }[curr], 0);
